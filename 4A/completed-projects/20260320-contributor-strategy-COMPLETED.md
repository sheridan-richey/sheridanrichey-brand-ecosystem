...
> **Archived** from `3R/docs/collaboration/contributor-strategy.md` (2026-03-20). Completion report for a shipped feature; current standards live in [`.cursor/rules/`](../../.cursor/rules/) and [AGENTS.md](../../AGENTS.md).
