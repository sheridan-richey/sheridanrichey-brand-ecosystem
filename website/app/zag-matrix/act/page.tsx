    ...
    <div className="min-h-screen bg-gradient-to-br from-light-bg to-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Physical Well-being</h3>
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Relationships</h3>
              <p className="text-graphite font-manrope">
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Momentum</h3>
              <p className="text-graphite font-manrope">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Energy Management</h3>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Performance Optimization</h3>
              <ul className="space-y-3 text-graphite font-manrope">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-zag-act-base rounded-full mt-2 mr-3 flex-shrink-0"></span>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-6">
                <div>
                  <h4 className="font-semibold text-phantom font-manrope mb-2">Mentors</h4>
                  <p className="text-graphite font-manrope text-sm">
                    People who've walked the path ahead of you and can guide your journey.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-phantom font-manrope mb-2">Peers</h4>
                  <p className="text-graphite font-manrope text-sm">
                    Colleagues and friends who understand your challenges and celebrate your wins.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-phantom font-manrope mb-2">Supporters</h4>
                  <p className="text-graphite font-manrope text-sm">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Building Momentum</h3>
              <ul className="space-y-3 text-graphite font-manrope">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-zag-act-base rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Sustaining Momentum</h3>
              <ul className="space-y-3 text-graphite font-manrope">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-zag-act-base rounded-full mt-2 mr-3 flex-shrink-0"></span>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/zag-matrix/zen" 
                className="inline-flex items-center px-6 py-3 border border-smoke text-base font-medium rounded-md text-phantom font-manrope bg-white hover:bg-light-bg transition-colors"
              >
