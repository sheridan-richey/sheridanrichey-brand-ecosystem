        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Mental Clarity</h3>
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Purpose</h3>
              <p className="text-graphite font-manrope">
            ...
            <div className="text-center p-6 rounded-lg border border-smoke hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-phantom font-manrope mb-3">Resilience</h3>
              <p className="text-graphite font-manrope">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Daily Practices</h3>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-phantom font-manrope">Career Applications</h3>
              <ul className="space-y-3 text-graphite font-manrope">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-zag-zen-base rounded-full mt-2 mr-3 flex-shrink-0"></span>
