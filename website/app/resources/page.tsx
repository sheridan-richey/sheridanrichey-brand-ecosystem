    ...
    <div className="min-h-screen bg-gradient-to-br from-light-bg to-white">
      ...
      <div className="bg-white border-b border-smoke">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="font-manrope text-xl text-graphite max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* The Bookshelf */}
          <div className="bg-white rounded-2xl shadow-sm border border-smoke p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center">
                <BookOpen className="h-6 w-6 text-white" />
              </div>
              <div>
                <h2 className="font-manrope text-2xl font-bold text-phantom">The Bookshelf</h2>
                <p className="font-manrope text-graphite">Foundational books that shaped the ZAG Matrix</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">The First 90 Days</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Michael Watkins</p>
                <p className="font-manrope text-sm text-phantom mb-3">
                ...
                <Link 
                  ...
                  className="inline-flex items-center text-primary-500 hover:text-primary-600 font-manrope text-sm font-medium"
                  target="_blank"
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Atomic Habits</h3>
                <p className="font-manrope text-sm text-graphite mb-3">James Clear</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Deep Work</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Cal Newport</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Buy Back Your Time</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Dan Martell</p>
                <p className="font-manrope text-sm text-phantom mb-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-smoke p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-manrope text-2xl font-bold text-phantom">The Toolkit</h2>
                <p className="font-manrope text-graphite">Software and tools I use and trust</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Cursor</h3>
                <p className="font-manrope text-sm text-graphite mb-3">AI-powered code editor</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Beehiiv</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Newsletter platform</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">v0.dev</h3>
                <p className="font-manrope text-sm text-graphite mb-3">AI UI generator</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">NotebookLM</h3>
                <p className="font-manrope text-sm text-graphite mb-3">AI research assistant</p>
                <p className="font-manrope text-sm text-phantom mb-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-smoke p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-manrope text-2xl font-bold text-phantom">Recommended Thinkers</h2>
                <p className="font-manrope text-graphite">Newsletters, blogs, and podcasts worth your time</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Sahil Bloom</h3>
                <p className="font-manrope text-sm text-graphite mb-3">The Curiosity Chronicle</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Ali Abdaal</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Sunday Snippets</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Tim Ferriss</h3>
                <p className="font-manrope text-sm text-graphite mb-3">5-Bullet Friday</p>
                <p className="font-manrope text-sm text-phantom mb-3">
              ...
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow">
                <h3 className="font-manrope font-bold text-phantom mb-2">Naval Ravikant</h3>
                <p className="font-manrope text-sm text-graphite mb-3">Almanack & Podcast</p>
                <p className="font-manrope text-sm text-phantom mb-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-smoke p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-manrope text-2xl font-bold text-phantom">Your Frameworks</h2>
                <p className="font-manrope text-graphite">Downloadable guides and tools I've created</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="border border-smoke rounded-lg p-4 hover:shadow-md transition-shadow bg-gradient-to-br from-primary-500/5 to-light-teal/5">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-manrope font-bold text-phantom">The Prompt Architect's Toolkit</h3>
                  <span className="inline-flex items-center px-2 py-1 bg-primary-500/10 rounded-full">
                    <span className="text-primary-500 font-manrope text-xs font-medium">New</span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <Link 
                    ...
                    className="inline-flex items-center font-manrope bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                  >
                    <Download className="mr-2 h-4 w-4" />
                    Download Free
                  </Link>
                  <span className="font-manrope text-xs text-graphite">PDF • 45 pages</span>
                </div>
              </div>
